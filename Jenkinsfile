        ...
        stage('Deploy for production') {
            ...
            steps {
                ...
                script {
                    ...
                    sed -i "/^image: ${DOCKER_ID}\\/${DOCKER_IMAGE}:movie-service/s/.*/${DOCKER_ID}\\/${DOCKER_IMAGE}:${DOCKER_TAG_MOVIE_SERVICE}/" iac/values.yaml
                    sed -i "/^image: ${DOCKER_ID}\\/${DOCKER_IMAGE}:cast-service/s/.*/${DOCKER_ID}\\/${DOCKER_IMAGE}:${DOCKER_TAG_CAST_SERVICE}/" iac/values.yaml
                    cat iac/values.yaml
